...
impl Keyboard {
    pub fn new() -> Self {
        let inputs = vec![
            ...
            RawInput::new("grave"),
            RawInput::new("alt:l"),
            RawInput::new("bracket:l"),
            RawInput::new("control:l"),
            RawInput::new("shift:l"),
            RawInput::new("os:l"),
            RawInput::new("minus"),
            RawInput::new("plus"),
            RawInput::new("alt:r"),
            RawInput::new("bracket:r"),
            RawInput::new("control:r"),
            RawInput::new("shift:r"),
            RawInput::new("os:r"),
...
fn virtual_keycode_into_raw_input_name(virtual_keycode: VirtualKeyCode) -> Option<&'static str> {
    match virtual_keycode {
        ...
        VirtualKeyCode::LAlt => Some("alt:l"),
        VirtualKeyCode::LBracket => Some("bracket:l"),
        VirtualKeyCode::LControl => Some("control:l"),
        VirtualKeyCode::LShift => Some("shift:l"),
        VirtualKeyCode::LWin => Some("os:l"),
        ...
        VirtualKeyCode::RAlt => Some("alt:r"),
        VirtualKeyCode::RBracket => Some("bracket:r"),
        VirtualKeyCode::RControl => Some("control:r"),
        VirtualKeyCode::RShift => Some("shift:r"),
        VirtualKeyCode::RWin => Some("os:r"),
